...
import AllPositions from "../../EvaluationData/AllPositions";
import AllTrees from "../../EvaluationData/AllTrees";
const AI_decision = [
  "",
  "",
  "",
...
export default HighwaySceneEvaluation;
